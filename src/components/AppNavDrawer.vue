...
<mu-drawer
 ...
 :zDepth="1">
  <mu-appbar :zDepth="0" class="exmaples-nav-appbar">
    <a href="#/" class="exmaples-appbar-title">Api docs</a>
    <!-- <mu-badge content="rc" class="exmaples-version" secondary/> -->
  </mu-appbar>
  <mu-divider/>
    <mu-list @change="handleMenuChange" :value="menuVal">
      <mu-list-item title="Get Start" toggleNested>
        <mu-list-item value="#/hellow" slot="nested" title="1"/>
        <mu-list-item value="#/" slot="nested" title="2"/>
        <mu-list-item value="#/" slot="nested" title="3"/>
      </mu-list-item>
      <mu-list-item title="Get Start1" toggleNested>
        <mu-list-item value="#/hellow" slot="nested" title="1"/>
        <mu-list-item value="#/" slot="nested" title="2"/>
        <mu-list-item value="#/" slot="nested" title="3"/>
      </mu-list-item>
